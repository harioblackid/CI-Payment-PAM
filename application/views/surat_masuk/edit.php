...
<form class="surat" method="post" action="<?=base_url('surat_masuk/save_change'); ?>">
    <div class="row mb-2">
        <div class="col-lg-12">
            <!-- Notifikasi -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" name="id_surat_masuk" value="<?= $data_surat->id_surat_masuk; ?>">
                        <input 
                            type="text" 
                            class="form-control" 
                            id="kode_surat" 
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    value="<?= $data_surat->tanggal_surat; ?>"
                                    >
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="tanggal_terima" 
                                    readonly 
                                    value="<?= date_indo($data_surat->tanggal_terima); ?>"
                                    >
                            </div>
